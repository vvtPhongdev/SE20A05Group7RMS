...
export type AdminTone = 'teal' | 'approved' | 'pending' | 'revision' | 'rejected' | 'slate';
...
export const AdminPageHeader = ({
  ...
  <header className={cn('grid gap-4 md:grid-cols-[1fr_auto] md:items-end', className)}>
    <div>
...
export const AdminCard = ({
  ...
  <Component
    className={cn(
      'rounded-lg border border-border-warm bg-clean-surface p-6 shadow-sm',
      className,
    )}
  >
    {children}
...
export const AdminSelectControl = ({
  label,
  onChange,
  options,
  value,

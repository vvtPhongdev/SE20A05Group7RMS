...
export const CandidateProfile: React.FC = () => {
  ...
  return (
    <CandidateDashboardPage>
      <CandidatePageHeader
        title="My Profile - Candidate"
        description="Keep contact details and career information current for active applications."
      />

      {loading ? <CandidateLoadingState label="Loading profile..." /> : null}

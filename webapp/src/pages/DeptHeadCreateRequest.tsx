...
export const DeptHeadCreateRequest: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-[1000px] pb-28">
      <header className="mb-6 flex flex-col gap-4 border-b border-border-warm pb-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden sm:block">
            ...
            />
            <input
              className="w-64 rounded-lg border border-border-warm bg-workflow-ivory py-1.5 pl-10 pr-4 text-sm outline-none focus:border-teal-command focus:ring-2 focus:ring-teal-command/20"

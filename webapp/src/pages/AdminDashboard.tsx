...
const activityFeed = [
  {
    text: 'New request from IT department',
    subject: '#RMS-9428',
    time: 'May 29 09:15',
    tone: 'border-teal-command',
  },
  {
    text: 'Interview completed: Nguyen Van A',
    subject: '',
    time: 'May 29 08:45',
    tone: 'border-pending',
  },
  {
    text: 'Plan approved: Marketing Specialist',
    subject: '',
    time: 'May 28 16:30',
    tone: 'border-approved',
  },
  {
    text: 'Offer sent to Tran Ngoc Mai',
    subject: '',
    time: 'May 28 14:20',
    tone: 'border-teal-command',
  },
  {
    text: 'Request rejected: Junior Intern',
    subject: '',
    time: 'May 28 11:05',
    ...
    <div className="mx-auto flex max-w-[1440px] flex-col gap-6">
      <section className="flex flex-col gap-4 border-b border-border-warm pb-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative flex h-10 min-w-0 items-center rounded-lg bg-surface-container-low px-3 text-on-surface-variant sm:w-[240px]">
            <Icon className="h-4 w-4 shrink-0 text-outline" name="search" />
            <input
              aria-label="Quick Search"
              className="h-full min-w-0 flex-1 border-none bg-transparent px-2 text-sm text-on-surface outline-none placeholder:text-outline focus:ring-0"

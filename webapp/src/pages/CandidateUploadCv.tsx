      ...
      <div className="grid grid-cols-12 gap-6 items-start">
                ...
                <tbody className="text-xs text-deep-charcoal font-medium">
                  {documents.map((doc) => (
                    ...
                    >
                      ...
                      {/* Version */}
                      <td className="px-6 py-4 font-mono text-[11px] text-slate-ink">
                        {doc.version}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        ...
                        {doc.parsingStatus === 'Parsing Failed' && (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-50 text-red-700 border border-red-200/50 text-[10px] font-bold">
                            <span className="w-1.5 h-1.5 rounded-full bg-red-600"></span> Parsing
                            Failed
                          </span>
                        )}
                      ...
                      <td className="px-6 py-4 text-right">
                        {doc.parsingStatus === 'Parsing Failed' ? (
                          ...
                          <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              className="p-1 hover:text-teal-command text-slate-ink"
                              title="View Details"
                            >
                              <Icons.visibility />
                            </button>
        ...
        <aside className="col-span-12 lg:col-span-4 space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-on-surface-variant font-semibold">
                    Only 3 core skills detected. Consider adding a 'Skills' section.
                  </p>
                </div>
              </li>
          ...
          <div className="bg-white border border-border-warm rounded-lg p-6 shadow-sm">
            ...
            <div className="relative pl-6 space-y-8 before:absolute before:left-[9px] before:top-1 before:bottom-1 before:w-[2px] before:bg-surface-container">
              ...
              <div className="relative">
                ...
                <p className="text-xs font-bold text-deep-charcoal leading-none">
                  Structured Data Ready
                </p>
                <p className="text-[10px] text-on-surface-variant mt-1 font-semibold">
                  JSON Mapping in progress...
                </p>
              </div>
              <div className="relative">
                <div className="absolute -left-[23px] w-[14px] h-[14px] rounded-full bg-stone-300 border-4 border-white"></div>
                <p className="text-xs font-bold text-on-surface-variant leading-none">
                  Embeddings Indexed
                </p>
                <p className="text-[10px] text-on-surface-variant mt-1 font-semibold">
                  Awaiting vector storage
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low border border-border-warm rounded-lg p-4 flex gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-deep-charcoal uppercase tracking-wider">
                Data Privacy
              </h4>
              <p className="text-[11px] text-on-surface-variant font-medium italic mt-1 leading-relaxed">
                Your CV documents are stored securely with AES-256 encryption. We retain CV history
                for 12 months following your last active application unless manually deleted.
              </p>
            </div>
          </div>
        </aside>

...
const kpis = [
  { label: 'Searchable CVs', value: '2,480', helper: '+12 today', tone: 'text-deep-charcoal' },
  { label: 'Avg. Similarity', value: '82%', helper: 'semantic match', tone: 'text-teal-command' },
  { label: 'Shortlisted Today', value: '14', helper: 'manual picks', tone: 'text-deep-charcoal' },
  { label: 'Locked Campaigns', value: '3', helper: 'approval required', tone: 'text-revision' },
];
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <label className="flex flex-col gap-1">
                ...
                <select
                  ...
                  value={campaign}
                >
                  <option>Engineering - Senior Platform (ENG-2024-012)</option>
                  <option>Design - Lead UX Researcher (DSN-2024-005)</option>
                  <option>Product - Senior Manager (PRD-2024-009)</option>
                </select>
              </label>

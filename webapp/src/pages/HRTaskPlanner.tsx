        ...
        <header className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <p className="mt-1 max-w-[70ch] text-sm leading-6 text-slate-ink">
              Track task plans assigned from approved recruitment campaigns.
            </p>
          </div>
          <button
            className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-border-warm bg-clean-surface px-4 text-sm font-semibold text-slate-ink transition hover:border-teal-command hover:text-teal-command"

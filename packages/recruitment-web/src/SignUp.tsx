        ...
        <section className="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-8 overflow-hidden bg-[#008378]">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-16">
              <span
                className="material-symbols-outlined text-white bg-white/20 p-2 rounded-lg"
            ...
            <div className="max-w-xl">
              ...
              <p className="text-lg text-white/90 mb-12">
                Create your account to manage hiring requests, track approvals, and coordinate
                recruitment plans in one central enterprise workspace.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4 group">
                  <div className="bg-white p-3 rounded-xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                    <span
                      className="material-symbols-outlined text-[#0D9488]"
                      style={{ fontVariationSettings: "'FILL' 1" }}
                    >
                      dashboard
                    </span>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      Tailored interfaces for HR, managers, and interviewers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      Monitor every candidate and approval stage instantly.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      Standardized paths for rapid, compliant hiring decisions.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="relative z-10 pt-12 border-t border-white/10">
            ...
            <div className="flex items-center gap-12 opacity-60 transition-all duration-300">
              <img
                alt="Client Logos"
                className="h-10 object-contain"
                src="https://lh3.googleusercontent.com/aida/ADBb0ui9Hq3VTe5SIAd02NuIEnSTJnxPi__iOv_vCPtQKkTuLOOKe3Ff3KCfJCOANIabjzw8iXRtlps747KgvpWSn_R30kmUSJOkuW5OSy6zVFAW-0pBTknT4mbxZdCEbLGuc0l1ajnPPc75BCfkPoWruxQ0nuqESGatqOp7Lca7gzDc4fQI9bohFU18l3ubaQtnQ4rb59vLCEEQ_Oq_5BP5Og6NWnHX2sybrvXUbwlWVQSFnbjIGkPKREfiqno"
              />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-md w-full mx-auto">
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-base text-[#57534E]">
                Fill in your details to get started with RecruitFlow
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <div className="flex items-center gap-1.5 mb-1.5">
                  ...
                  <span
                    className="material-symbols-outlined text-[16px] text-[#6d7a77] cursor-help"
                    title="Contact your HR administrator for your team's code"
                  >
                    info
                  </span>
                </div>
              ...
              {/* Role Selector */}
              <div>
                <span className="block text-sm text-[#3d4947] font-medium mb-3">
                  Select Your Role
                </span>
              ...
              <div className="flex items-start gap-3">
                ...
                <label className="text-xs text-[#57534E]" htmlFor="tos">
                  I agree to the{' '}
                  <a className="text-[#0D9488] underline" href="#tos">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a className="text-[#0D9488] underline" href="#privacy">
                    Privacy Policy
                  </a>
                  .
                </label>
              ...
              {/* SSO */}
              <button
                className="w-full py-4 flex items-center justify-center gap-3 border border-[#0D9488] text-[#0D9488] font-semibold rounded-lg hover:bg-[#0D9488]/5 active:scale-[0.98] transition-all"
                type="button"
              >
            ...
            <footer className="mt-12 text-center">
              <p className="text-xs text-[#57534E] opacity-70">
                Need help?{' '}
                <a className="text-[#0D9488] hover:underline" href="#help">
